...
public final class new_issue_direct_return extends javax.swing.JInternalFrame {

    static DBControl db = new DBControl();
    Date today = new Date();

    public new_issue_direct_return() {
        try {
            initComponents();
            ...
            Logger.getLogger(new_issue_direct_return.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        setTitle("New Issue Direct Return");
        ...
        jLabel14.setText("New Issue Direct Return");
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 210, 25));
        ...
        getContentPane().add(txtIssue_date, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 210, 25));
...
//            txtEquipmentNo.grabFocus();
            ...
            JOptionPane.showMessageDialog(null, "Please enter the Return Date", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void txtStockCodeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtStockCodeKeyReleased
        try {
            ...
            ResultSet rs = DBControl.getResultFromLocalDB("SELECT * FROM stock_details "
                    + "WHERE stock_code LIKE '" + Search + '%' + "' OR description LIKE '" + Search + '%' + "' ORDER BY stock_code ASC");
...
//        }
    ...
    private void txtStockCodeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtStockCodeMouseClicked
        if (tblStockLoad.isVisible()) {
            ...
            try {
                tblStockLoad.setVisible(true);
                jScrollPane5.setVisible(true);
                ResultSet rs11 = DBControl.getResultFromLocalDB("SELECT * FROM stock_details ORDER BY stock_code ASC");
    ...
    private void formMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseMoved
        scm.utils.HideLoadTable.ThreeTables(tblStockLoad, jScrollPane5, tblEquipLoad, jScrollPane6, tblAccountLoad, jScrollPane8);        // TODO add your handling code here:
    ...
    private void saveIssue() {
        try {
            ...
            for (int i = 0; i < tblIssueList.getRowCount(); i++) {
                ...
                db.setResult("INSERT INTO issue_direct_return(issue_date,account_code,equipment_no,"
                        + "stock_code,quantity,unit_price,sub_total,total,user,time) "
                        + "VALUES('" + issue_date + "','" + account_code + "','" + equipment_no + "',"
                        + "'" + stock_code + "','" + quantity + "','" + unit_price + "',"
                        + "'" + sub_total + "','" + tott + "','" + updated_by + "','" + timestamp + "')");
